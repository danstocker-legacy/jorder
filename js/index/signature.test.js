/*global jorder, jOrder, module, test, ok, equal, strictEqual, deepEqual, raises */
(function (testing, jOrder) {
    ...
    test("Key extraction", function () {
        ...
        deepEqual(string_multi.keys(testing.jsonX[0]), ['Tolkien_3'
        ], "Extracting composite key from string type fields");
        deepEqual(array.keys(testing.jsonX[0]), [5, 6, 43, 21, 88], "Extracting multiple keys from array type field");
        deepEqual(text.keys(testing.jsonX[0]), ['Lord', 'of', 'the', 'rings'
        ], "Extracting multiple keys from text type field");
